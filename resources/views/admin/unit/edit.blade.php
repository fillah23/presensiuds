            ...
            <div class="page-heading">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Edit Unit</h3>
                            <p class="text-subtitle text-muted">Edit Data Unit</p>
                        </div>
                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('unit.update', $unit->id) }}" method="POST" id="unitForm">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="type" name="type" required>
                                                ...
                                                <option value="program_studi" {{ old('type', $unit->type) === 'program_studi' ? 'selected' : '' }}>Program Studi</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="parent-group">
                                            ...
                                            <select class="form-select" id="parent_id" name="parent_id">
                                                ...
                                                @foreach($fakultas as $fak)
                                                    <option value="{{ $fak->id }}" {{ old('parent_id', $unit->parent_id) == $fak->id ? 'selected' : '' }}>
                                                        {{ $fak->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $unit->name) }}" required placeholder="Masukkan nama fakultas/program studi">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="code" class="form-label">Kode Unit</label>
                                            <input type="text" class="form-control" id="code" name="code" value="{{ old('code', $unit->code) }}" placeholder="Contoh: FT, FMIPA, TI, SI">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Deskripsi optional tentang unit">{{ old('description', $unit->description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
