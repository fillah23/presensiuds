                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Buat Presensi Baru</h3>
                            <p class="text-subtitle text-muted">Formulir untuk membuat jadwal presensi</p>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Form Presensi Baru</h5>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('presensi.store') }}" method="POST">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('resume_kelas') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Masukkan topik atau materi yang akan dibahas..." required>{{ old('resume_kelas') }}</textarea>
                                            @error('resume_kelas')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select @error('durasi_menit') is-invalid @enderror" 
                                                        ...
                                                        <option value="60" {{ old('durasi_menit') == '60' ? 'selected' : '' }}>60 menit</option>
                                                        <option value="90" {{ old('durasi_menit') == '90' ? 'selected' : '' }}>90 menit</option>
                                                        <option value="120" {{ old('durasi_menit') == '120' ? 'selected' : '' }}>120 menit</option>
                                                        <option value="180" {{ old('durasi_menit') == '180' ? 'selected' : '' }}>180 menit</option>
                                                    </select>
                                                    @error('durasi_menit')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select @error('batas_terlambat') is-invalid @enderror" 
                                                        ...
                                                        <option value="5" {{ old('batas_terlambat') == '5' ? 'selected' : '' }}>5 menit</option>
                                                        <option value="10" {{ old('batas_terlambat') == '10' ? 'selected' : '' }}>10 menit</option>
                                                        <option value="15" {{ old('batas_terlambat') == '15' ? 'selected' : 'selected' }}>15 menit</option>
                                                        <option value="20" {{ old('batas_terlambat') == '20' ? 'selected' : '' }}>20 menit</option>
                                                        <option value="30" {{ old('batas_terlambat') == '30' ? 'selected' : '' }}>30 menit</option>
                                                        <option value="45" {{ old('batas_terlambat') == '45' ? 'selected' : '' }}>45 menit</option>
                                                        <option value="60" {{ old('batas_terlambat') == '60' ? 'selected' : '' }}>60 menit</option>
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="bi bi-check-circle me-1"></i>Buat Presensi
                                            </button>
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <h6>Tips Membuat Presensi:</h6>
                                    <ul class="small">
                                        <li>Pastikan waktu mulai tidak kurang dari 5 menit dari sekarang</li>
                                        <li>Durasi minimal 15 menit, maksimal 180 menit</li>
                                        <li>Pilih program studi untuk mahasiswa yang boleh presensi</li>
                                        <li>Hanya mahasiswa dengan prodi yang sesuai yang bisa presensi</li>
                                        <li>Kode presensi akan dibuat otomatis (8 karakter)</li>
                                    </ul>

                                    <h6 class="mt-3">Setelah Dibuat:</h6>
                                    <ul class="small">
                                        <li>Bagikan kode presensi kepada mahasiswa</li>
                                        <li>Gunakan mode display untuk proyektor</li>
                                        <li>Mahasiswa akses via: <strong>{{ url('/presensi') }}</strong></li>
                                        <li>Presensi otomatis berakhir sesuai durasi</li>
                                    </ul>
                                </div>
                            </div>
        ...
        fetch('{{ route("admin.presensi.get-prodi") }}')
            ...
            .then(data => {
                ...
                data.forEach(function(prodi) {
                    const selected = '{{ old('prodi') }}' == prodi.id ? 'selected' : '';
    ...
    function loadKelasByMultipleProdis(prodiNames) {
        ...
        fetch(`{{ route("admin.presensi.get-kelas") }}?${prodiQuery}`)
            ...
            .then(data => {
                ...
                @if(old('kelas'))
                    $('#kelas').val(@json(old('kelas'))).trigger('change');
                @endif
            })
            .catch(error => {
